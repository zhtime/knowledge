...
![image-20210517194416105](https://picturebedzhanghui.oss-cn-hangzhou.aliyuncs.com/img/image-20210517194416105.png)
...
![image-20210517194557548](https://picturebedzhanghui.oss-cn-hangzhou.aliyuncs.com/img/image-20210517194557548.png)
...
```
示例 ： 
	 mysqldump -u root -p123456 demo_03 --add-drop-table > demo_03.sql;

```

![image-20210517200226673](https://picturebedzhanghui.oss-cn-hangzhou.aliyuncs.com/img/image-20210517200226673.png)
...
![image-20210517201216411](https://picturebedzhanghui.oss-cn-hangzhou.aliyuncs.com/img/image-20210517201216411.png)

![image-20210517201259252](https://picturebedzhanghui.oss-cn-hangzhou.aliyuncs.com/img/image-20210517201259252.png)
...
![image-20210517201106131](https://picturebedzhanghui.oss-cn-hangzhou.aliyuncs.com/img/image-20210517201106131.png)
...
```sql
mysqlimport -u root -p123456 demo_03 /var/lib/mysql-files/tb_book.txt;
```



如果需要导入**sql**文件,可以使用mysql中的source 指令 : 

```
source /var/lib/mysql-files/tb_book.sql;
...
mysqlshow -u root -p123456 test --count

#查询test库中book表的详细情况
mysqlshow -u root -p123456 test book --count
...
![image-20210520180643263](https://picturebedzhanghui.oss-cn-hangzhou.aliyuncs.com/img/image-20210520180643263.png)
...
![image-20210520183424686](https://picturebedzhanghui.oss-cn-hangzhou.aliyuncs.com/img/image-20210520183424686.png)

![image-20210520183541179](https://picturebedzhanghui.oss-cn-hangzhou.aliyuncs.com/img/image-20210520183541179.png)
...
![image-20210520183243107](https://picturebedzhanghui.oss-cn-hangzhou.aliyuncs.com/img/image-20210520183243107.png)
...
![image-20210520183353133](https://picturebedzhanghui.oss-cn-hangzhou.aliyuncs.com/img/image-20210520183353133.png)
...
![image-20210815185350542](https://picturebedzhanghui.oss-cn-hangzhou.aliyuncs.com/img/image-20210815185350542.png)
...
![image-20210520184022871](https://picturebedzhanghui.oss-cn-hangzhou.aliyuncs.com/img/image-20210520184022871.png)
...
![image-20210520184516367](https://picturebedzhanghui.oss-cn-hangzhou.aliyuncs.com/img/image-20210520184516367.png)

![image-20210520184416274](https://picturebedzhanghui.oss-cn-hangzhou.aliyuncs.com/img/image-20210520184416274.png)
...
![image-20210520184709953](https://picturebedzhanghui.oss-cn-hangzhou.aliyuncs.com/img/image-20210520184709953.png)
...
![image-20210520184836473](https://picturebedzhanghui.oss-cn-hangzhou.aliyuncs.com/img/image-20210520184836473.png)
...
![image-20210520185954204](https://picturebedzhanghui.oss-cn-hangzhou.aliyuncs.com/img/image-20210520185954204.png)
...
![image-20210520190657179](https://picturebedzhanghui.oss-cn-hangzhou.aliyuncs.com/img/image-20210520190657179.png)
...
![image-20210520190813763](https://picturebedzhanghui.oss-cn-hangzhou.aliyuncs.com/img/image-20210520190813763.png)

![image-20210520190907350](https://picturebedzhanghui.oss-cn-hangzhou.aliyuncs.com/img/image-20210520190907350.png)
...
![image-20210520192256187](https://picturebedzhanghui.oss-cn-hangzhou.aliyuncs.com/img/image-20210520192256187.png)
...
![image-20210520191538333](https://picturebedzhanghui.oss-cn-hangzhou.aliyuncs.com/img/image-20210520191538333.png)
...
![image-20210520191754500](https://picturebedzhanghui.oss-cn-hangzhou.aliyuncs.com/img/image-20210520191754500.png)

由于该语句执行时间很短，为0。38s ， 所以不会记录在慢查询日志中。

![image-20210520192118094](https://picturebedzhanghui.oss-cn-hangzhou.aliyuncs.com/img/image-20210520192118094.png)

```
select * from tb_item;
```

![image-20210520191942794](https://picturebedzhanghui.oss-cn-hangzhou.aliyuncs.com/img/image-20210520191942794.png)
...
![image-20210520192037291](https://picturebedzhanghui.oss-cn-hangzhou.aliyuncs.com/img/image-20210520192037291.png)

3） 查看慢查询日志文件

直接通过cat 指令查询该日志文件 ： 

![image-20210520192337902](https://picturebedzhanghui.oss-cn-hangzhou.aliyuncs.com/img/image-20210520192337902.png)



如果慢查询日志内容很多， 直接查看文件，比较麻烦， 这个时候可以借助于mysql自带的 mysqldumpslow 工具， 来对慢查询日志进行分类汇总。 

![image-20210520192405350](https://picturebedzhanghui.oss-cn-hangzhou.aliyuncs.com/img/image-20210520192405350.png)
...
![image-20210520192702000](https://picturebedzhanghui.oss-cn-hangzhou.aliyuncs.com/img/image-20210520192702000.png)
...
![1554477759735](https://picturebedzhanghui.oss-cn-hangzhou.aliyuncs.com/img/1554477759735.png)
...
![1554479387365](https://picturebedzhanghui.oss-cn-hangzhou.aliyuncs.com/img/1554479387365.png)
...
![1554544658640](https://picturebedzhanghui.oss-cn-hangzhou.aliyuncs.com/img/1554544658640.png)

在该数据库中，查询user表中的数据：

![1554544679538](https://picturebedzhanghui.oss-cn-hangzhou.aliyuncs.com/img/1554544679538.png)
...
![1555075760661](https://picturebedzhanghui.oss-cn-hangzhou.aliyuncs.com/img/1555075760661.png)
...
<img src="https://picturebedzhanghui.oss-cn-hangzhou.aliyuncs.com/img/image-20210831140814202.png" alt="image-20210831140814202" style="zoom: 67%;" />
...
![1555077276426](https://picturebedzhanghui.oss-cn-hangzhou.aliyuncs.com/img/1555077276426.png)
...
![1555081714638](https://picturebedzhanghui.oss-cn-hangzhou.aliyuncs.com/img/1555081714638.png)
...
![1555152703824](https://picturebedzhanghui.oss-cn-hangzhou.aliyuncs.com/img/1555152703824.png)
...
![1555235426739](https://picturebedzhanghui.oss-cn-hangzhou.aliyuncs.com/img/1555235426739.png)
...
![1555235982584](https://picturebedzhanghui.oss-cn-hangzhou.aliyuncs.com/img/1555235982584.png)



#### 4.11.4 原理

![1555235982584](https://picturebedzhanghui.oss-cn-hangzhou.aliyuncs.com/img/aop-datasource.png)
